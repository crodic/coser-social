        ...
        <div className="mt-4">
          <div className="flex items-start space-x-2">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-500">@sakura</div>
            </div>
          </div>
          <Textarea
          ...
          <div className="mt-4 rounded-lg border p-4">
            <div className="flex items-center justify-between">
              <div className="text-sm font-medium">Thêm vào</div>
          ...
          <Button className="mt-4 w-full bg-blue-500 hover:bg-blue-600">Đăng bài</Button>
        </div>
      </DialogContent>
    </Dialog>
  );
